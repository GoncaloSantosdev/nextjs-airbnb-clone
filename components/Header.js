  ...
  return (
    <header className='sticky top-0 z-50 grid grid-cols-3 bg-white shadow-md p-5 md:px-10'>
        ...
        <div className='flex items-center md:border-2 rounded-full py-2 md:shadow-sm'>
            <input value={searchInput} onChange={(e) => setSearchInput(e.target.value)} className='pl-5 bg-transparent outline-none flex-grow placeholder-gray-400' type="text" placeholder={placeholder || 'Start your search'}/>
            <MagnifyingGlassIcon className='hidden md:inline h-8 bg-red-400 text-white rounded-full p-2 cursor-pointer md:mx-3'/>
        </div>
